...
namespace DataverseModel
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.Incident"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.Incident> IncidentSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.Incident>();
			}
		}
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseModel.Template"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseModel.Template> TemplateSet
		{
			get
			{
				return this.CreateQuery<DataverseModel.Template>();
			}
		}
